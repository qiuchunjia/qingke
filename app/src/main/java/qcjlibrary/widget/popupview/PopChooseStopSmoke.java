...
public class PopChooseStopSmoke extends PopView {
    private TextView tv_praise;
    private TextView tv_cancle;

    public PopChooseStopSmoke(Activity activity, Object object,

...
public class PopChooseStopDrink extends PopView {
    private TextView tv_praise;
    private TextView tv_cancle;

    public PopChooseStopDrink(Activity activity, Object object,

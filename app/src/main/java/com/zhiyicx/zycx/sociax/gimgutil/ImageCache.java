...
package com.zhiyicx.zycx.sociax.gimgutil;
...
import com.zhiyicx.zycx.BuildConfig;
...
public class ImageCache {
    ...
    public static ImageCache getInstance(ImageCacheParams cacheParams) {
        ...
        if (BuildConfig.DEBUG)
            Log.d(TAG, "Memory cache created (is = " + instance.toString()
                    + ")");
    ...
    public static class ImageCacheParams {
        ...
        public ImageCacheParams(Context context, String uniqueName) {
            ...
            System.out.println("diskCacheDir " + diskCacheDir);
        }
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath = Environment.MEDIA_MOUNTED.equals(extStoreState) || !isExternalStorageRemovable() ? extCachePath : cacheDirPath;

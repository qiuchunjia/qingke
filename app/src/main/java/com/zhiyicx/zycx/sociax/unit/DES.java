...
public class DES {
    ...
    public static String encrypt1(String encryptString, String encryptKey) throws Exception {
        ...
        // return base64Encode(desEncrypt(encryptString.getBytes()));
    }

	/*
     * public String base64Encode(byte[] s) { if (s == null) return null; return
	 * Base64.encodeToString(s, Base64.DEFAULT);
	 * 
	 * }
	 */
}
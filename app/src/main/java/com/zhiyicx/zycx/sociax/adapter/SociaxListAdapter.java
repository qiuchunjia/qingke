...
public abstract class SociaxListAdapter extends BaseAdapter {
        ...
        if (null != list) {
            if (list.size() == 20) {
                ...
                Toast.makeText(context,
                        com.zhiyicx.zycx.R.string.refresh_success,
                ...
                Toast.makeText(context,
                        com.zhiyicx.zycx.R.string.refresh_error,
                        Toast.LENGTH_SHORT).show();
            } else {
                ListData<SociaxItem> tempList = new ListData<SociaxItem>();
    ...
    public void doRefreshHeader() {
        ...
        if (refresh != null) {
            ...
            if (null != isRefreshActivity
                ...
                Anim.refresh(
                        context,
                        refresh,
                        com.zhiyicx.zycx.R.drawable.spinner_black_60);
            if (null != isRefreshActivity
        ...
        /*
		 * if(this.getFirst() == null){ msg.what = REFRESH_NEW; }else{
		 */
   ...
   /*
	...
	public void initHeadImageFetcher() {
		...
		mHeadImageFetcher.setLoadingImage(R.drawable.header);
